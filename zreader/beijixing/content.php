<?php
	...
	$allPage = ceil($contentLength / $perpage);
	if($currentPage < 1) {
		$currentPage = 1;
	}
	...
	$pageInfo -> contentLength = $contentLength;
	$pageInfo -> allPage = $allPage;
	$pageInfo -> startNum = $startNum;
	$pageInfo -> endNum = $endNum;
	$contentInfo = mssubstr($content, $startNum, $perpage);
	$json = new stdClass();
	$json -> pageInfo = $pageInfo;
	$json -> contentInfo = $contentInfo;
	 ...
	 * @return int 切分后字符串
	 */
	function mssubstr($str, $start, $length) {
